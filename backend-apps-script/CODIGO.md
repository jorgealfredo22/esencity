...
Copiar cada bloque en su archivo correspondiente dentro del editor de Apps Script.
...
## Nombres de imágenes para Drive

Subir a la carpeta `SERVICE_IMAGES_FOLDER_ID` con estos nombres exactos:
